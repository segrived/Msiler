...
namespace Quart.Msiler.Annotations
{
    /// <summary>
    ...
    /// expression
    /// is defined in the <see cref="MacroAttribute.Expression" /> property. When applied on a method, the
    /// target
    /// template parameter is defined in the <see cref="MacroAttribute.Target" /> property. To apply the
    /// macro silently
    ...
    public sealed class MacroAttribute : Attribute
    {
        ...
        /// <summary>
        /// Identifies the target parameter of a <see cref="SourceTemplateAttribute">source template</see> if
        /// the
